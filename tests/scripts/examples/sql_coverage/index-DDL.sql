...
CREATE INDEX P_SCAN1_TREE ON P_SCAN (A);
CREATE INDEX P_SCAN2_TREE ON P_SCAN (B, C);
CREATE INDEX P_SCAN3_TREE ON P_SCAN (D, E, F);
...
CREATE INDEX R_SCAN1_TREE ON R_SCAN (A);
CREATE INDEX R_SCAN2_TREE ON R_SCAN (B,C);
CREATE INDEX R_SCAN3_TREE ON R_SCAN (D, E, F);
